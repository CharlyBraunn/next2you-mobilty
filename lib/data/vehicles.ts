...
export const vehicles: Vehicle[] = [
    ...
    },
    {
        ...
        image: "/images/fleet/boxer-3.jpg",
        images: [
            "/images/fleet/boxer-3.jpg",
            "/images/fleet/boxer-4.jpg",
            "/images/fleet/boxer-1.jpg",
            "/images/fleet/boxer-2.jpg",
        ],
        volume: "10m³",
        fuel: "Diesel",
        transmission: "Manuelle",
        description: "Grand fourgon 10m³ robuste et spacieux, idéal pour déménagements et transports professionnels. Stationné en parking souterrain à La Garenne-Colombes.",
        details: "Grand fourgon Peugeot Boxer de 10m³, idéal pour vos déménagements et transports volumineux. Stationné en parking souterrain sécurisé à La Garenne-Colombes, à proximité de Bois-Colombes et de l'A86.\n\nFournis gratuitement : diable, sangles/tendeurs, support téléphone, câble de chargement.\n\n⚠️ Véhicule stationné dans un parking souterrain — vérifiez la hauteur du véhicule (2,5m de haut) avant d'engager dans des parkings couverts et des rues étroites.",
        features: ["Parking souterrain", "Galerie de toit", "Climatisation", "Diable inclus"],
        link: "https://fr.getaround.com/location-voiture/la-garenne-colombes/peugeot-boxer-1959495",
        category: "utilitaire",
    },
    {
    ...
    },
    {
        ...
        fuel: "Diesel",
        transmission: "Manuelle",
        description: "Fiable et pratique, idéal pour vos besoins en proche banlieue ouest.",
        details: "Disponible 24/7 (Connect) à Neuilly-sur-Seine. Très économique (~5L/100km). Siège passager escamotable (plancher plat). Accessoires fournis : diable, tendeurs, couverture de déménagement, support de téléphone, câble iPhone Lightning. (Vitesse bridée à 110km/h).",
