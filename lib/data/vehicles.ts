...
export const vehicles: Vehicle[] = [
    ...
    },
    {
        ...
        fuel: "Diesel",
        transmission: "Manuelle",
        description: "Véhicule utilitaire compact et maniable, parfait pour la région parisienne.",
        details: "Ce Kangoo jaune est idéalement situé à Courbevoie. Il dispose de tout le confort nécessaire pour vos déplacements ou petits déménagements en Île-de-France.",
        features: ["Radar de recul", "Climatisation", "Bluetooth"],
        link: "https://fr.getaround.com/location-voiture/courbevoie/renault-kangoo-express-1234567",
        category: "utilitaire",
    },
    {
