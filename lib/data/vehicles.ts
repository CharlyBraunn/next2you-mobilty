...
export const vehicles: Vehicle[] = [
    {
        ...
        details: "Disponible 24/7 (Connect). Situé au cœur du 18ème (Mairie). Stationnement résidentiel gratuit dans la zone. Finition rLink avec GPS et Bluetooth. Diable et support téléphone fournis.",
        features: ["Parking gratuit 18e", "GPS intégré", "24/7 Connect", "Diable inclus"],
    ...
    },
    {
        ...
        details: "Disponible 24/7 via Getaround Connect. Idéalement situé à Clichy proche périphériques. Siège passager escamotable pour plancher plat. Accessoires fournis : diable, tendeurs, couverture.",
        features: ["24/7 Connect", "Diable inclus", "Siège escamotable", "Bluetooth"],
    ...
    },
    {
        ...
        details: "Disponible 24/7 (Connect) à 2min de la gare de Bois-Colombes. Finition rLink complète (GPS, Clim). État mécanique irréprochable. Accessoires fournis : diable, couverture, tendeurs.",
        features: ["90cv Dynamique", "Proche Gare", "Full Options", "Diable inclus"],
    ...
    },
    {
        ...
        details: "Disponible 24/7 (Connect) proche gare SNCF. Très économique (~5L/100km). Siège passager escamotable (plancher plat). Diable, tendeurs et couverture inclus. (Vitesse bridée à 110km/h).",
        features: ["Urbain agile", "Proche Gare", "Économique", "Diable inclus"],
    ...
    },
    {
        ...
        details: "Modèle récent (2019) Grand Confort. Hauteur < 2m (accès parkings). Longueur utile 2,53m. Situé sur place réservée à Bois-Colombes Mairie. Diable (70kg), couverture et tendeurs fournis.",
        features: ["6m³ (40 cartons)", "Hauteur < 2m", "Place réservée", "Diable inclus"],
    ...
    },
    {
        ...
        details: "Disponible 24/7 (Connect) proche gare Bois-Colombes. Format compact idéal pour Paris. Compatible ISOFIX pour les familles. État impeccable et prise en main très simple.",
        features: ["Ultra Maniable", "ISOFIX", "Proche Gare", "Bluetooth"],
    ...
    },
    {
        ...
        details: "Disponible 24/7 (Connect) à 2min de la gare de Bois-Colombes. État quasi neuf. Parfaite pour la ville (stationnement facile) ou escapades week-end (Régulateur, Bluetooth).",
        features: ["Automatique", "État quasi neuf", "Bluetooth", "Régulateur"],
