...
export const vehicles: Vehicle[] = [
    {
        ...
        details: "Situé au cœur du 18ème (Mairie). Aide au démarrage en côte, Bluetooth, Régulateur & Limiteur de vitesse. Accessoires fournis : diable de transport, tendeurs, couverture de déménagement, support de téléphone, câble iPhone Lightning.",
        features: ["Aide dém. en côte", "Bluetooth", "Diable", "Régulateur", "Climatisation"],
    ...
    },
    {
        ...
        features: ["Aide dém. en côte", "Bluetooth", "Diable inclus"],
    ...
    },
    {
        ...
        features: ["Aide dém. en côte", "Régulateur", "Place réservée", "Climatisation"],
    ...
    },
    {
        ...
        features: ["Proche Gare", "Aide dém. en côte", "Diable inclus"],
